...
CubeL3DRenderer.prototype.render = function(cubeData) {
    ...
    {
        this._np.animate(64, this._buffer, this._renderStep.bind(this));
        return this;
    }
    ...
    var _hasOffCell = false;
    for (var i = 0, numCells = 64; i < numCells; i++)
    {
        var cell = this.cube.cells[i];
        var ci = i * 3;
        if (cell.on)
        {
            this._buffer[ci] = cell.color[1];
            this._buffer[ci + 1] = cell.color[0];
            this._buffer[ci + 2] = cell.color[2];
        } else
        {
            _hasOffCell = true;
