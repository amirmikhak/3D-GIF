var CubeEventEmitter = require('./cubeEventEmitter');
...
var CubeRenderer = function CubeRenderer(opts) {
    ...
    Object.defineProperty(this, 'cube', {
        ...
        set: function(newCube) {
            if (newCube === null)
            {
            } else if (newCube instanceof Cube)
            {
            } else if (!newCube.hasOwnProperty('cells') || !newCube.hasOwnProperty('size'))
            {
                if (!newCube.cells)
                {
                    console.error('a');
                } else if (!newCube.hasOwnProperty('size'))
                {
                    console.error('b');
                }
                console.error('xx', newCube.constructor.name);
...
CubeRenderer.prototype.startRenderLoop = function() { console.log('CubeRenderer.startRenderLoop()'); };
CubeRenderer.prototype.stopRenderLoop = function() { console.log('CubeRenderer.stopRenderLoop()'); };
